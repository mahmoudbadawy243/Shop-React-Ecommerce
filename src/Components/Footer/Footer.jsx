...
import img1 from "../../assets/images/amazon_pay.png";
import img2 from "../../assets/images/amircan_express.png";
import img3 from "../../assets/images/master_card.png";
import img4 from "../../assets/images/pay_pal.png";
import img5 from "../../assets/images/app_store.png";
import img6 from "../../assets/images/and.png";

export default function Footer() {
  return (
    <>
      <div className="footer bg-[#f0f3f2] mt-10 py-10 px-3">
